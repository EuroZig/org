...
Software prägt unsere Welt, doch allzu oft stellt sie Profit über die Menschen und verbraucht unnötig Ressourcen. EuroZig tritt an, um dem etwas entgegenzusetzen. Als Teil der europäischen Zig-Community stehen wir für eine neue Ära der Systemprogrammierung: Wir unterstützen Menschen dabei, Software zu entwickeln, die schnell, ressourcenschonend und radikal nutzerfreundlich ist.

Um diese Vision zu verwirklichen, bieten wir Bildung, Orientierung und eine offene Gemeinschaft. Wir unterstützen Programmiererinnen und Programmierer dabei, exzellentes Handwerk zu leisten, und zeigen Wege für die Entwicklung ethischer Software auf, die primär den Nutzenden dient.

= § 1 Name, Sitz, Geschäftsjahr

+ Der Verein führt den Namen „EuroZig“. Er soll in das Vereinsregister eingetragen werden; nach der Eintragung führt er den Zusatz „e.V.“.
...
Zweck von EuroZig ist die Förderung von Bildung, Wissenschaft und Forschung im Zusammenhang mit der Programmiersprache Zig.
...
+ EuroZig fördert die Volks- und Berufsbildung:
  ...
  + Durch die Durchführung von Workshops und die Erstellung von Lehrmaterialien über die Programmiersprache Zig und FOSS.

+ EuroZig fördert Wissenschaft und Forschung:

  + Durch die Unterstützung der Entwicklung von Projekten, die dem Ökosystem der Programmiersprache Zig zugutekommen.

  + Durch die Förderung des europäischen Ökosystems für freie und quelloffene Software.

  + Durch den Austausch mit der wissenschaftlichen Gemeinschaft im Bereich der Informatik.

+ EuroZig verfolgt ausschließlich und unmittelbar gemeinnützige Zwecke im Sinne des Abschnitts „Steuerbegünstigte Zwecke“ der Abgabenordnung (§ 52). EuroZig ist selbstlos tätig und verfolgt nicht in erster Linie eigenwirtschaftliche Ziele.
...
+ Voraussetzung für den Erwerb der Mitgliedschaft ist ein schriftlicher Aufnahmeantrag an den Vorstand von EuroZig.

+ Der Vorstand entscheidet über die Annahme des Antrags.

+ Die Mitglieder haben die in der Beitragsordnung festgelegten Mitgliedsbeiträge zu entrichten.

+ Die Mitgliedschaft endet durch Austritt, Ausschluss, Tod oder – bei juristischen Personen – durch den Verlust der Rechtsfähigkeit. Der Austritt kann zum 31. Dezember eines jeden Jahres erfolgen und muss dem Vorstand mindestens 4 Wochen vorher schriftlich mitgeteilt werden.

+ Ein Mitglied kann durch den Vorstand oder die Mitgliederversammlung aus dem Verein ausgeschlossen werden, wenn folgende Bedingungen vorliegen:

  + Das Mitglied verstößt grob gegen die Bestimmungen der Satzung und/oder den Zweck und die Ziele des Vereins.

  + Das Mitglied zahlt trotz wiederholter Mahnung über einen Zeitraum von 12 Monaten keine Mitgliedsbeiträge.

+ Es gibt ordentliche und fördernde Mitglieder.

  + Ordentliche Mitglieder sind natürliche Personen, die den Zweck und die Ziele des Vereins unterstützen. Sie haben das Recht zur Teilnahme an der Mitgliederversammlung. Volljährige Mitglieder haben das aktive und passive Stimmrecht in der Mitgliederversammlung. Minderjährige Mitglieder haben nur das aktive Stimmrecht.
...
+ Die Mitgliederversammlung besteht aus ordentlichen Mitgliedern des Vereins, die jeweils eine Stimme haben.

+ Die Mitgliederversammlung entscheidet über grundlegende Fragen zu den Grundsätzen, Aktivitäten und der allgemeinen Ausrichtung des Vereins.
...
+ Die Mitgliederversammlung hat das Recht, über alle Angelegenheiten zu entscheiden, die ihr von einem ordentlichen Mitglied vorgelegt werden.
...
+ Über die Versammlung ist mindestens ein schriftliches Ergebnisprotokoll anzufertigen. Das Protokoll wird von der Protokollführung und der Versammlungsleitung unterschrieben.

= § 6 Der Vorstand

+ Der Vorstand besteht aus drei Personen; nur natürliche Personen können Vorstandsmitglieder sein. Sie werden für eine Amtszeit von 2 Jahren gewählt. Die jeweiligen Vorstandsmitglieder bleiben nach Ablauf ihrer Amtszeit so lange im Amt, bis ein Nachfolger gewählt ist.

+ Der Vorstand wählt aus seiner Mitte einen Vorsitzenden, einen zweiten Vorsitzenden und einen Schatzmeister.

+ Zur rechtsverbindlichen Vertretung genügt die gemeinsame Unterschrift von zwei Vorstandsmitgliedern.
